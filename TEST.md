...
| chat send / persist (real) | `make test-e2e-chat` (S258 send + S520 multi-part + S572 JSON-Think, via `run-chat-gui-e2e.sh`); `make test-e2e-full` (S204 3-layer, **operator-gated**) | — |
